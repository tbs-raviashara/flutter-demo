import 'package:demo/components/clipper.dart';
...
class PopupDesign extends StatefulWidget {
  PopupDesign({Key key}) : super(key: key);

  @override
  _PopupDesignState createState() => _PopupDesignState();
}

class _PopupDesignState extends State<PopupDesign> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      SizedBox(height: 20),
                      CustomButton(
                        label: _nameController != null ? "REGISTER" : "Login",
                        primaryColor: Theme.of(context).primaryColor,
                        secondaryColor: Colors.white,
                        onPressed: () {},
                      ),
